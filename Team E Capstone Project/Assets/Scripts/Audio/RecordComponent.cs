...
public class RecordComponent : MonoBehaviour, IAudioDetectionCallback
{
    ...
    void Update()
	{
        //check input to see if we should start or stop recording
    ...
    void StartRecording()
	{
        ...
        //PlaybackComp.UpdateCurrentTrack(null);
...
public class RecordingTrack : ISound
{
    ...
    public void FixedUpdate()
	{
        ...
        if (Playing)
		{
			...
			{
                //this is where we have to interperate and execute track event commands
