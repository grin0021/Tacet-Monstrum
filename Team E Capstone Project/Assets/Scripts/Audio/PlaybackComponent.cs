...
public class PlaybackComponent : MonoBehaviour
{
    ...
    [SerializeField]
    InteractableButton PlayButton;

    [SerializeField]
    InteractableButton StopButton;
    ...
    private void Awake()
    {
        ...
        if (PlayButton != null)
        PlayButton.OnPressed.AddListener(this.OnPlayPressed);
        if(StopButton != null)
        StopButton.OnPressed.AddListener(this.OnStopPressed);
